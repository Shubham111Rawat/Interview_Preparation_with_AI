...
const SpinnerLoader = () => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="inline w-5 h-5 text-gray-200 animate-spin dark:text-white fill-gray-900"
        viewBox="0 0 100 101"
        fill="none"
      ...
      >
        ...
        <path
          ...
          28.8227 92.871 24.3692 89.8176 
          ...
          27.0806C84.9175 31.0421 88.7427 
          32.4973 93.9676 39.0409Z"
          fill="currentFill"
        />
      </svg>
