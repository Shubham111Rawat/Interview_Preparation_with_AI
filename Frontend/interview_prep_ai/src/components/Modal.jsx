...
const Modal = ({ children, isOpen, onClose,title, hideHeader}) => {
  ...
  return  <div className='fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/40'>
               ...
               >
                 ...
                 <button
                   type='button'
                   className='text-gray-400 bg-transparent hover:bg-orange-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5 cursor-pointer'
                   onClick={onClose}
                 >
